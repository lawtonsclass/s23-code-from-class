...
0000000000001169 <main>:
    ...
    116e:	48 89 e5             	mov    rbp,rsp   # put the addr. of the current stack top in rbp
    ...
    1187:	48 8d 15 76 0e 00 00 	lea    rdx,[rip+0xe76]      # rdx = &password string  # 2004 <_IO_stdin_used+0x4>
    118e:	48 89 d6             	mov    rsi,rdx  # second arg. -- "password123" string
    1191:	48 89 c7             	mov    rdi,rax  # first arg. -- argv[1]
    ...
    119b:	75 11                	jne    11ae <main+0x45> # jump (goto) if nonzero -- if stirngs were not equal
    119d:	48 8d 05 6c 0e 00 00 	lea    rax,[rip+0xe6c]   # load string 2010     # 2010 <_IO_stdin_used+0x10>
    11a4:	48 89 c7             	mov    rdi,rax           # make itfirst arg.
    11a7:	e8 b4 fe ff ff       	call   1060 <puts@plt>   # call printing func.
    11ac:	eb 0f                	jmp    11bd <main+0x54>
    11ae:	48 8d 05 6a 0e 00 00 	lea    rax,[rip+0xe6a]    # load string 201f    # 201f <_IO_stdin_used+0x1f>
    11b5:	48 89 c7             	mov    rdi,rax            # make it first arg.
    11b8:	e8 a3 fe ff ff       	call   1060 <puts@plt>    # call puts (printf)
