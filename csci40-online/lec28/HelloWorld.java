// In Java, everything is a class. If you want a function, you need to
// put it inside a class. HelloWorld is public, so it's visible to the
// outside world--that means other people could import it and use it.
